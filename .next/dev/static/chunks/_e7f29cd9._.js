...
"[project]/client/pages/VerifyEmail.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            const verifyEmail = {
                "VerifyEmail.useEffect.verifyEmail": async ()=>{
                    ...
                    try {
                        ...
                        setTimeout({
                            "VerifyEmail.useEffect.verifyEmail": ()=>navigate("/dashboard")
                        }["VerifyEmail.useEffect.verifyEmail"], 3000);
                    } catch (err) {
...
_s(VerifyEmail, "ACaKDFrAwRe8Wr9pjLyoOuxc4QY=", false, function() {
    return [
...
//# sourceMappingURL=_e7f29cd9._.js.map