                                    ...
                                    <div className="grid grid-cols-2 gap-1.5">
                                        {option.values.map((value, index) => (
                                            <button
                                                ...
                                                className={`relative flex flex-col items-center justify-center border-2 rounded p-1.5 transition text-center ${selectedOptions[option.id] === value.id
                                    ...
                                    <div className="grid grid-cols-2 gap-1">
                                        {option.values.map((value) => (
                                            <button
                                                ...
                                                className={`border-2 rounded-lg p-1 transition text-center text-xs ${selectedOptions[option.id] === value.id
                                    ...
                                    <div className="grid grid-cols-2 gap-1.5">
                                        {option.values.map((value) => (
                                            <button
                                                ...
                                                className={`relative border-2 rounded overflow-hidden transition flex flex-col items-center justify-center p-1 ${selectedOptions[option.id] === value.id
                                                    ? "border-purple-500"
