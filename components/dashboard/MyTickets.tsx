                    ...
                    {ticketReplies.length === 0 ? (
                        ...
                        <div className="space-y-3 sm:space-y-4 max-h-96 overflow-y-auto">
                            {ticketReplies.map((reply) => (
                                <div
                                    key={reply.id}
                                    className={`rounded-lg p-3 sm:p-4 border ${reply.sender_type === "admin"
            ...
            <div className="flex gap-1.5 sm:gap-2 mb-6 sm:mb-8 flex-wrap">
                {["all", "open", "in-progress", "resolved"].map((status) => (
                    <button
                        ...
                        className={`px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg font-semibold text-xs sm:text-sm transition-colors ${filter === status
