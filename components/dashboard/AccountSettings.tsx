...
export default function AccountSettings() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8">
                ...
                <div className="space-y-6 sm:space-y-8 animate-fadeIn">
                    <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        {socialFormSuccess && (
                            <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                                <p className="text-sm text-green-800">
                                    Social media profiles updated successfully!
                                </p>
                            </div>
                        )}
            ...
            {activeTab === "delete" && (
                <div className="space-y-6 sm:space-y-8 animate-fadeIn">
                    <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 shadow-sm border border-red-100 hover:shadow-md transition-shadow">
                        <h2 className="text-lg sm:text-xl font-bold text-red-600 mb-4 sm:mb-6 flex items-center gap-2">
                            <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6" />
                            Delete Account
                        </h2>

                        <div className="bg-red-50 p-4 rounded-lg mb-6 text-red-800 text-sm">
                            <p className="font-bold mb-2">Warning: This action is permanent!</p>
                            <p>
                                Deleting your account will remove all your data, including order
                                history, saved addresses, and profile information. This cannot be
                                undone.
                            </p>
                        </div>
                        ...
                        {deleteFormError && (
                            <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex gap-3">
                                <AlertCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                                <p className="text-sm text-red-800">{deleteFormError}</p>
                            </div>
                        )}
